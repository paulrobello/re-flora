  ...
  return (
    <>
      <div className="min-h-screen py-8 md:py-16 px-4 flex justify-center items-start">
        {/* Letter Container */}
        <div className="letter-paper max-w-5xl w-full mx-auto rounded-sm md:rounded-md p-8 md:p-16 text-slate-800 shadow-2xl">
          ...
          <div className="absolute top-20 left-0 w-full h-px opacity-30 pointer-events-none">
            <div
              ...
              style={{ animationDelay: "0s", top: "10%" }}
            ></div>
            <div
              className="sparkle-line"
              style={{ animationDelay: "2s", top: "40%" }}
            ></div>
            <div
              className="sparkle-line"
              style={{ animationDelay: "1s", top: "70%" }}
            ></div>
          </div>
          ...
          <header className="relative flex flex-col items-center justify-center mb-16 text-center border-b-2 border-slate-200 pb-12">
            ...
            <p className="text-xl md:text-2xl text-slate-600 max-w-2xl mx-auto italic font-serif leading-relaxed">
              "An experimental relaxation game where you design and nurture your
              own island paradise."
            </p>
          </header>
          ...
          <main className="space-y-16">
            ...
            <section className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-800 mb-6 font-serif border-b border-slate-300 inline-block pb-2">
                A Digital Sanctuary
              </h2>
              <p className="text-lg text-slate-700 leading-loose font-serif">
                Using vibrant voxel rendering, <strong>Re: Flora</strong> allows
                you to cultivate a diverse ecosystem of plants, shape terrain,
                and create a personal sanctuary. The game emphasizes creativity
                and tranquility with no failure states, focusing instead on the
                joy of watching your garden evolve.
              </p>
            </section>

            {/* Features Grid */}
            <section>
              <h2 className="text-3xl font-bold text-center text-slate-800 mb-12 font-serif">
                Features
              </h2>
            ...
            <section className="bg-slate-50 p-8 rounded-lg border border-slate-200">
              <div className="flex flex-col md:flex-row items-start gap-12">
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-6 font-serif text-slate-800">
                    Botanical Reality
                  </h2>
                ...
                <div className="flex-1">
                  <div className="bg-emerald-900/5 p-6 rounded-lg border-l-4 border-emerald-700 italic text-slate-700 font-serif">
                    We're integrating elements of real-world botany to create a
                    world that feels alive and grounded, yet magical.
                  </div>
          ...
          <footer className="mt-20 pt-10 border-t border-slate-200 text-center text-slate-500 font-serif italic">
            ...
            <p className="text-sm">
              Built with Rust, Vulkan, and a love for nature.
            </p>
          </footer>
        </div>
      </div>
