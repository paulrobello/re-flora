...
// Single-hash height approximation (cheap replacement for 12-iteration Box-Muller)
...
void main() {
    ...
    // Skip VSM texture sampling, use analytical shadow only
    ...
    // Approximate srgb_to_linear with x*x (gamma 2.0) instead of pow(x,2.4)
